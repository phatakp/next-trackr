...
export default function Charts() {
  const { data, isLoading } = useQuery({
    queryKey: ["getGroupStats"],
    queryFn: () => getGroupStats(1),
  });
  ...
  return (
    <div className="mx-auto flex flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[25rem] lg:grid-cols-1 xl:max-w-[30rem]">
        <Card className="lg:max-w-md" x-chunk="charts-01-chunk-0">
          <CardHeader className="space-y-0 pb-2">
            <CardDescription>Expenses Today</CardDescription>
            <CardTitle>
              <AmountField
                amount={1446}
                className="text-4xl tabular-nums justify-start"
              />
            </CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter className="flex-col items-center justify-center gap-1">
      ...
      <div className="grid w-full flex-1 gap-6 lg:max-w-[24rem]">
        ...
        <Card className="max-w-sm" x-chunk="charts-01-chunk-3">
          ...
          <CardFooter className="flex flex-row border-t p-4">
            <div className="flex w-full items-center gap-2">
              <div className="grid flex-1 auto-rows-min gap-0.5">
                ...
                <AmountField
                  amount={38400}
                  className="text-xl justify-start"
                  icon
                />
                {/* <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                  562
      ...
      <div className="grid w-full flex-1 gap-6">
        ...
        <Card className="max-w-xs order-first" x-chunk="charts-01-chunk-6">
          <CardHeader className="p-4 pb-0">
          ...
          <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-2">
            <AmountField amount={3893001} className="text-3xl tabular-nums" />
