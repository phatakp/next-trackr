...
import { getExpenseVsSavingsStats } from "@/server/txn.actions";
...
export default function ExpenseSummaryChart() {
  ...
  const { data: stats, isLoading } = useQuery({
    queryKey: ["exp-vs-savings-stats"],
    queryFn: () => getExpenseVsSavingsStats(),
    refetchOnMount: true,
  });
    ...
    <Card>
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          ...
          <CardDescription>
            Showing summary of daily expenses for the last 3 months
          </CardDescription>
        </div>
